...
using static WindowsDeskBand.DeskBand.Interop.Struct.DESKBANDINFO.DBIF;
using static WindowsDeskBand.DeskBand.Interop.Struct.DESKBANDINFO.DBIM;
using static WindowsDeskBand.DeskBand.Interop.Struct.DESKBANDINFO.DBIMF;
